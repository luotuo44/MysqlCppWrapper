...
```cpp
    ...
    {
        std::cout<<row.getColumn<int>("id")<<"\t"<<row.getColumn<std::string>("name")<<"\t"<<row.getColumn<int>("score")<<std::endl;
    }
...
```cpp
    ...
    for(; it != end; ++it)
    {
        std::cout<<it->getColumn<int>(0)<<"\t"<<it->getColumn<std::string>(1)<<"\t"<<it->getColumn<int>(2)<<std::endl;
    }


    auto first_row = *tmp;
    std::cout<<first_row.getColumn<int>("id")<<"\t"<<first_row.getColumn<std::string>("name")<<"\t"<<first_row.getColumn<int>("score")<<std::endl;
